...
{
    const char* pszTimestamp = "Viltracoin Must Rise";
    const CScript genesisOutputScript = CScript() << ParseHex("080784710fa689ad5023690c80f3a49b8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1730310281, 2000190324, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7334d55fc58653b6ad329c761e1435578792de391b136a1a82c9d73f8a07faa6"));
        assert(genesis.hashMerkleRoot == uint256S("0xc196eaa70dd485f18fce3eb8dad2f3ccb4d685436d28937ca5b3013e579b6fbe"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("147.45.42.240", "147.45.42.240", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("viltracointools.com", "dnsseed.viltracointools.com"));
        //vSeeds.push_back(CDNSSeedData("viltracoinpool.org", "dnsseed.viltracoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xe674e0fb61a7cf8ea04cd642e6f32ebc068441e05194905632ceaecf40848b01"))
        ...
        chainTxData = ChainTxData{
            ...
            1730310281, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1730310281, 775558, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x129f889e5cb02aa280c735b9909a762692827af03de538909ad28c90dabd3721"));
        assert(genesis.hashMerkleRoot == uint256S("0xc196eaa70dd485f18fce3eb8dad2f3ccb4d685436d28937ca5b3013e579b6fbe"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("147.45.42.240", "147.45.42.240"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.viltracoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x128d3c6b3f83c6bf03adbc0b489e8d84319c27fb06eefce2353ed45fac4b6bf8")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1730310281, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5533dcd4b66c3969bc0f975940aea9173632800df0ec9a3a87308260448f4edd"));
        assert(genesis.hashMerkleRoot == uint256S("0xc196eaa70dd485f18fce3eb8dad2f3ccb4d685436d28937ca5b3013e579b6fbe"));
