...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s viltracoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  viltracoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded viltracoin transaction") + "\n" +
              "  viltracoin-tx [options] -create [commands]   " + _("Create hex-encoded viltracoin transaction") + "\n" +
              "\n";
