...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/viltracoin-project/viltracoin>";
    const std::string URL_WEBSITE = "<https://viltracoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Viltracoin version %s\n", FormatFullVersion());
}
